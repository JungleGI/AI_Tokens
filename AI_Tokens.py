...
#Tickers
tickers = ('9104','7533','13051','22858','23756','24261','15584','16876')
...
#Charting
Chart1 = df_cum_daily_returns[['AIOZ Network','Humans.ai','Artificial Liquid Intelligence']]
Chart2 = df_cum_daily_returns[['ARC','Dynex','ChainGPT','OctaSpace','Oraichain']]
#Chart3 = df_cum_daily_returns[['Oasys','OriginTrail''MOBOX','Aurory','Treasure','Nakamoto Games','Gods Unchained','Ocean Protocol']]
st.line_chart(Chart1)
st.line_chart(Chart2)
#st.line_chart(Chart3),'3911''2467'
